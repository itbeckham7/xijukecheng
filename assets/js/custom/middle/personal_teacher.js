...
$(window).ready(function () {
    ...
    $('#script_ATag_Btn').on('click', function () {
        curPageNo = 0;
        content_type_id = '1';
    ...
    $('#dubbing_ATag_Btn').on('click', function () {
        curPageNo = 0;
        totalPageCount = 0;
        content_type_id = '2';
    ...
    $('#head_ATag_Btn').on('click', function () {
        curPageNo = 0;
        totalPageCount = 0;
        content_type_id = '3';
    ...
    $('#shooting_ATag_Btn').on('click', function () {
        curPageNo = 0;
        totalPageCount = 0;
        content_type_id = '4';
    ...
    var submenuType = $('#' + setMediaType() + '_ATag_Btn');
    if (submenuType.length) submenuType.click();
