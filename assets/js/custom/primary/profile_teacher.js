...
$(window).ready(function () {
    ...
    function Share_make_Item(orderNum,item_title,item_id){
        ...
        output_html += '<a href="' + baseURL+'primary/community/view/' +item_id+'" class="share_item_title" style = "top:'+item_top_str+'">';
    ...
    $('#shared_content_delete_btn').click(function () {
        ...
        $.ajax({
            type:'post',
            url:baseURL+'primary/users/delete_shared_content',
            dataType: "json",
    ...
    function comment_make_Item(orderNum,item_title,item_id){
        ...
        output_html += '<a href="' + baseURL+'primary/community/view/' +item_id+'" class="comment_item_title" style = "top:'+item_top_str+'">';
        output_html += item_title;
        output_html += '</a>';
    ...
    $('#commented_content_delete_btn').click(function () {
        ...
        $.ajax({
            type:'post',
            url:baseURL+'primary/users/delete_commented_content',
            dataType: "json",
            data:{user_id:teacherId,content_id:content_id},
            success:function(res){
                if(res.status=='success'){
    ...
    function getAllCheckedClass(teacherId){
        ...
        $.ajax({
            type: "post",
            url: baseURL+"primary/users/update_teacher_class",
            dataType: "json",
            data: changedInfo,
            success: function(res) {
                if(res.status=='success') {
