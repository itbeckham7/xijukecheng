...
<div class="hdmenu">
    <div style="position: relative; height: 100%">
        ...
        <a id = "hdmenu_studentwork" href="<?= base_url('primary/').'work/student';?>" style="top: 27.2%; left: 1.1%; width: 31.9%; height: 48.5%;"></a>
        <a id = "hdmenu_profile" href="<?= base_url('primary/').'users/profile/'.$user_id;?>" style="top: 3.9%; left: 37.1%; width: 26.1%; height: 90.4%;"></a>
...
<script src="<?= base_url('assets/js/custom/primary/personal_teacher.js') ?>" type="text/javascript"></script>
