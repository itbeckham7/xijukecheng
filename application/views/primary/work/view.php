...
<div class="course_type_menu">
    <div style="position: relative; height: 100%">
        ...
        <a href="<?=base_url('primary/work/script').'/'.$user_id;?>"   style="top: 8.51%; left: 1.219%; width: 21.18%; height: 81%;"></a>
        <a href="<?=base_url('primary/work/dubbing').'/'.$user_id;?>"  style="top: 8.51%; left: 26.829%; width: 21.18%; height: 81%;"></a>
        <a href="<?=base_url('primary/work/head').'/'.$user_id;?>"   style="top: 8.51%; left: 52.29%; width: 21.18%; height: 81%;"></a>
        <a href="<?=base_url('primary/work/shooting').'/'.$user_id;?>"  style="top: 8.51%; left: 77.82%; width: 21%; height: 81%;"></a>
    </div>
</div>
<!-------------Head Menu------------------------------------------------------->
<div class="hdmenu">
    <div style="position: relative; height: 100%">
        ...
        <a id = "hdmenu_profile" href="<?= base_url('primary/').'users/profile/'.$loggedIn_UserID;?>" style="top: 3.9%; left: 37.1%; width: 26.1%; height: 90.4%;"></a>
...
<script>
        ...
        this.make_item = function (orderNo,contentInfo){
            ...
            if(logedInUsertype=='2'){
                ...
                if(userType=='1'){//if user is teacher and teacher see his information
                    ...
                    output_html += '<a class = "list_title" href="'+base_url+'primary/work/view/'+contentInfo['content_id']+'">';
                ...
                if(contentInfo['public']=='1')
                {
                    ...
                    output_html += '<a class = "list_title2" href="'+base_url+'primary/work/view/'+contentInfo['content_id']+'">';
                    output_html += contentInfo['content_title']+'</a>';
    ...
    function fitwindow() {
        ...
        $('.list_title2').css('font-size',realFontSize+'px');
        $('.list_title2').css('padding-top',padTopVal+'px');
    ...
    function uploadWork(self) {
        ...
        jQuery.ajax({
            type: "post",
            url: baseURL+"primary/work/uploadJob",
            dataType: "json",
    ...
    jQuery('#content_delete_form').submit(function (e) {
        ...
        if(userType=='1')
        {
            ...
            ajaxURL = baseURL+"primary/work/delete_content";
        }else{
            if(logedInUsertype=='2'){///this mean current user is student
                ...
                if (contentLocal == '0' && contentCloud == '0') {
                    ...
                    ajaxURL = baseURL + "primary/work/update_content";
                    ajaxData.content_local = contentLocal;
                    ajaxData.content_cloud = contentCloud;
                }
            }else {
    ...
    function shareContentItem(content_id) {
          jQuery.ajax({
              type: "post",
              url: baseURL+"primary/work/share_content",
              dataType: "json",
              data: {student_id:studentId,content_type_id:content_type_id,content_id: content_id},
              success: function(res) {
                  if(res.status=='success') {
...
<script src="<?= base_url('assets/js/custom/primary/work_list_view.js') ?>" type="text/javascript"></script>
