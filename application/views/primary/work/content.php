...
<div class="work_view_area">
    <?php if($content_type_id=='1') { ?>
        ...
        <div class="content-wrap" id="content_wrap" style="left: 0; top: 15%; width: 100%; height: 85%;position: absolute;overflow-y: scroll">
            <?= $scriptText ?>
        </div>
        <?php
...
<script src="<?= base_url('assets/js/custom/primary/work_view.js') ?>" type="text/javascript"></script>
