...
<?php if($this->session->userdata("loggedin") != FALSE){?>
    <a href="<?= base_url().'primary/users/profile/'.$loged_In_user_id;?>" class="btn" id="sh_profile_btn"  style="background:url(<?= $imageAbsDir.'base/profile.png';?>) no-repeat;background-size: 100% 100%;"> </a>
...
<script>
    ...
    function clickStudent()///ajax_function for teacher let to edit student and itself information
    {
        $.ajax({
           type:"post",
           url:baseURL+'primary/nwork/getContents',
           dataType:"json",
    ...
    function changeContentEval(userid,contentId,hegeVal){
        $.ajax({
            type:"post",
            url:baseURL+'primary/nwork/changedContentEval',
            dataType:"json",
    ...
    function content_delete_ajax(contentId){
        jQuery.ajax({
            url:baseURL+"primary/nwork/delete_content",
            type:"post",
            dataType: "json",
    ...
    function showNContent(self) {
        ...
        if(curTab!='note')
        {
            ...
            jQuery.ajax({
                url:baseURL+"primary/nwork/get_NoteDetails",
                type:"post",
                dataType: "json",
