...
$returnURL = 'primary/community/index';
...
<?php if($content_type_id!='4'){ ?>
    ...
    <div class="shooting-content">
        ...
        <script>
            ...
            var vplayer = videojs('videoPlayer',{controls:true,width:1280,nativeControlsForTouch:false,height:712,preload:'auto',loop:false},function(){
