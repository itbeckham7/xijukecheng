...
<script>
    ...
    function saveProfileInfo(teacherId,teacher_fullname,teacher_nickname,teacher_sex){
        ...
        $.ajax({
            type: "post",
            url: baseURL+"primary/users/update_teacher_personal",
            dataType: "json",
            data: changedInfo,
    ...
    function updatePassword(){
        ...
        $.ajax({
            type: "post",
            url: baseURL+"primary/users/update_password",
            dataType: "json",
            data: changedInfo,
            success: function(res) {
                if(res.status=='success') {
...
<script src="<?= base_url('assets/js/custom/primary/profile_teacher.js') ?>" type="text/javascript"></script>