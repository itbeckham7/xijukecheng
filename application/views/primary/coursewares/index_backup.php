...
<div class="back-btn">
    <a onmouseover="hover_back()" onmouseout="out_back()" href="#"  onclick="history.back()">
...
<style type="text/css">
    ...
    .msg_modal_content { background: url(<?= base_url('assets/images/sandapian/base/warning_msg.png')?>); background-size: 100% 100%; width:100%;height:100%;}
</style>
