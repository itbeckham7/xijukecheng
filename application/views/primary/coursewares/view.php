...
<style>
    ...
    .subware-dubbing{ position: absolute; left: 13.34%; top: 0.73%; width: 8.02%; height: 9.66%; }
...
<input type="hidden" id="base_url" value="<?= base_url('primary/')?>">
<div class="bg">
    <img src="<?= base_url('assets/images/frontend/coursewares/view/bg.jpg')?>" class="background_image">
</div>
...
<div class="hdmenu">
    <?php if($this->session->userdata("loggedin") != FALSE): ?>
        <div style="position: relative; height: 100%">
            <img id="course_menu_img" src="<?= $hd_menu_img_path.'hdmenu_normal.png';?>">
            <a onmouseover="hover_work()" onmouseout="out_work()" href="<?= base_url($myworkURL);?>" style="top: 27.2%; left: 1.1%; width: 31.9%; height: 48.5%;"></a>
            <a onmouseover="hover_profile()" onmouseout="out_profile()" href="<?= base_url('primary/').'users/profile/'.$loged_In_user_id;?>" style="top: 3.9%; left: 37.1%; width: 26.1%; height: 90.4%;"></a>
            <a onmouseover="hover_comm()" onmouseout="out_comm()" href="<?= base_url('primary/').'community/index';?>" style="top: 27.2%; left: 67%; width: 31.9%; height: 48.5%;"></a>
        </div>
    <?php endif; ?>
</div>
...
<div class="back-btn">
    <a onmouseover="hover_back()" onmouseout="out_back()" href="#"  onclick="return_back()">
...
<?php if($subware_isexist['script'] == 0) : ?>
    <div class="subware-script">
        <a id="script" subware_path = "nosubware"><img src="<?= base_url('assets/images/frontend/coursewares/view/script.png')?>"></a>
    </div>
<?php endif;?>
...
<?php if($subware_isexist['dubbing'] == 0) : ?>
    <div class="subware-dubbing">
        <a id="dubbing" subware_path = "nosubware"><img src="<?= base_url('assets/images/frontend/coursewares/view/dubbing.png')?>"></a>
    </div>
<?php endif; ?>
...
<script>
    ...
    function hover_profile() { $('#course_menu_img').attr('src',hdmenuImgPath+'hdmenu_profile_sel.png'); }
    function out_profile() { $('#course_menu_img').attr('src',hdmenuImgPath+'hdmenu_normal.png'); }
    ...
    function  return_back() {
        ...
        {
            window.location = baseURL+'primary/coursewares/index';
        }else{
            //history.back();
            window.location = baseURL+'primary/coursewares/index';
