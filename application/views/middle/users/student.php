...
<div class="bg" style="background-color: #e8f9ff;">
    <img src="<?= base_url('assets/images/middle/profile/bg-student.png') ?>" class="background_image">
</div>
...
<script>
    ...
    function updateStudentProfile() {
        ...
        $.ajax({
            type: "post",
            url: baseURL + "middle/users/update_student_person",
            dataType: "json",
            data: changedInfo,
...
<script src="<?= base_url('assets/js/custom/middle/profile_student.js') ?>" type="text/javascript"></script>