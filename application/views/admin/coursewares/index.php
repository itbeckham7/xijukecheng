                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="cwInfo_tbl">
                            ...
                            <tr>
                                ...
                                <th style="width:230px;"><?php echo $this->lang->line('Operation');?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php foreach($coursewares as $courseware):
                                ...
                                <tr>
                                    ...
                                    <td align="center" data-course-id="<?= $courseware->course_id ?>"><?php echo $courseware->course_name;?></td>
                                    <td align="center" data-school-type-id="<?= $courseware->school_type_id ?>"><?php echo $courseware->school_type_name;?></td>
                                    <td align="center">
    ...
    <div class="modal-body">
        <form class="form-horizontal" enctype="multipart/form-data" action=""  id="cw_addNew_submit_form" role="form" method="post" accept-charset="utf-8">
            <div class="form-body">
                ...
                <input type="hidden" id="add_courseware_type" name="add_cw_type" value="0">
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="swFileUpload" class="col-md-2 control-label"><?php echo $this->lang->line('UploadCourseware');?>:</label>
                    <div class="col-md-4">
    ...
    <div class="modal-body">
        <form class="form-horizontal" enctype="multipart/form-data" action=""  id="cw_edit_submit" role="form" method="post" accept-charset="utf-8">
            <div class="form-body">
                ...
                <input type="hidden" id="edit_courseware_type" name="cw_type" value="0">
                <div class="form-group">
                    <label class=" col-md-2 control-label"><?php echo $this->lang->line('CourseName');?>:</label>
                    <div class="col-md-3">
...
<script>
  ...
  function edit_cw(self)
  {
      ...
      var school_type_id = trtag.cells[3].getAttribute("data-school-type-id");
...
<script src="<?= base_url('assets/js/custom/admin/cw.js')?>"></script>
