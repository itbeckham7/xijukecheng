                        ...
                        <table class="table table-striped table-bordered table-hover" id="schoolInfo_tbl">
                            ...
                            <?php foreach($schools as $school):
                                ...
                                <tr>
                                  ...
                                  <td align="center">
                                      <button class='btn btn-sm btn-success' onclick='edit_school(this);' data-class_arr='<?= $school->class_arr;?>' school_id = '<?php echo $school->school_id;?>'><?php echo $this->lang->line('Modify');?></button>
...
<script src="<?= base_url('assets/js/custom/admin/school.js') ?>" type="text/javascript"></script>