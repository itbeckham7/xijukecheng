                                ...
                                <form action="#" class="form-horizontal">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id = "nunit_name_search" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <form action="#" class="form-horizontal">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" id = "nunit_keyword_search" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="nunitsInfo_tbl">
                            ...
                            <tr>
                                ...
                                <th style="width:15%;"><?php echo $this->lang->line('UnitName');?></th>
                                <th style="width:13%;"><?php echo $this->lang->line('ChildCourseName');?></th>
                                <th style="width:20%;"><?php echo $this->lang->line('CourseName');?></th>
                            ...
                            <tbody>
                                <?php foreach($nunitSets as $nunit):
                                    $pub  = ($nunit->nunit_publish=='1')? $this->lang->line('UnPublish'): $this->lang->line('Publish')
                                    ?>
                                    <tr>
                                        <td><?= $nunit->nunit_sn;?></td>
                                        <td><?= $nunit->nunit_name;?></td>
                                        <td><?= $nunit->childcourse_name;?></td>
                                        <td><?= $nunit->course_name;?></td>
                                        <td><?= $nunit->school_type_name;?></td>
                                        <td>
                                            <button class="btn btn-sm btn-success"  nunit_photo="<?= $nunit->nunit_photo;?>" onclick="edit_nunit(this);" nunit_id = <?= $nunit->nunit_id;?>><?php echo $this->lang->line('Modify');?></button>
                                            <button class="btn btn-sm btn-warning" onclick="delete_nunit(this);"  nunit_id = <?php echo $nunit->nunit_id;?>><?php echo $this->lang->line('Delete');?></button>
                                            <button style="width:70px;" class="btn btn-sm btn-danger"  onclick="publish_nunit(this);" nunit_id = <?= $nunit->nunit_id;?>><?php echo $pub;?></button>
                                        </td>
                                    </tr>
                                <?php endforeach;?>
                            </tbody>
...
<div id="add_nunit_modal" class="modal fade" tabindex="-1" data-width="680">
    ...
    <div class="modal-body" style="padding-bottom:0">
        <form class="form-horizontal" enctype="multipart/form-data" action=""  id="add_nunit_submit_form" role="form" method="post" accept-charset="utf-8">
            <div class="form-body">
                <div class="form-group">
                    <label class="col-md-2 control-label"><?php echo $this->lang->line('UnitName');?>:</label>
                    <div class="col-md-4">
                        <input type="text" class="form-control input-inline" name="add_nunit_name" id = "add_nunit_name" value="">
                    </div>
                    <label class="col-md-2 control-label"><?php echo $this->lang->line('UnitSn');?>:</label>
                    <div class="col-md-4">
                        <input type="text" class="form-control input-inline" name="add_nunit_sn" id = "add_nunit_sn" value="">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="file" id="add_nunit_upload_img" name = "add_file_name" onchange="add_upload_image();">
                        <p class="help-block"><?php echo $this->lang->line('ImageUploadDescription');?></p>
                    </div>
                    <div class="col-md-2"></div>
                    <div class="col-md-4">
                        <img width="240" height="200" src="#"  class="img-rounded " alt="Image 300x300" id="add_nunit_preview_image">
                    </div>
                </div>
            </div>
    </div>
        ...
        <div class="form-group">
            <div class="row">
               <div class="col-md-offset-1 col-md-2" style="text-align: left;margin-left: 3%;">
                   <button type = "submit" class="btn green" style="width:80px"><?php echo $this->lang->line('Save');?></button>
               </div>
            </div>
        </div>
    </div>
...
<div id="edit_nunit_modal" class="modal fade" tabindex="-1" data-width="680">
    ...
    <div class="modal-body" style="padding-bottom:0">
        <form class="form-horizontal" enctype="multipart/form-data" action=""  id="edit_nunit_submit_form" role="form" method="post" accept-charset="utf-8">
            <div class="form-body">
                <div class="form-group">
                    <label class="col-md-2 control-label"><?php echo $this->lang->line('UnitName');?>:</label>
                    <div class="col-md-4">
                        <input type="text" class="form-control input-inline" name="edit_nunit_name" id = "edit_nunit_name" value="">
                    </div>
                    <label class="col-md-2 control-label"><?php echo $this->lang->line('UnitSn');?>:</label>
                    <div class="col-md-4">
                        <input type="text" class="form-control input-inline" name="edit_nunit_sn" id = "edit_nunit_sn" value="">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label"><?php echo $this->lang->line('ChildCourseName');?>:</label>
                ...
                <div class="form-group">
                    <label for="cwImageUpload" class="col-md-2 control-label"><?php echo $this->lang->line('CoursewareImage');?></label>
                    <div class="col-md-3">
                        <input type="file" id="edit_nunit_upload_img" name = "edit_file_name" onchange="edit_upload_image();">
                        <p class="help-block"><?php echo $this->lang->line('ImageUploadDescription');?></p>
                    </div>
                    <div class="col-md-2"></div>
                    <div class="col-md-4">
                        <img width="240" height="200" src="#"  class="img-rounded " alt="Image 300x300" id="edit_nunit_preview_image">
                    </div>
                </div>
            </div>
    </div>
    <div class="form-actions">
        <div class="form-group">
            <div class="row">
                <div class="col-md-offset-1 col-md-2" style="text-align: left;margin-left: 3%;">
                    <button type = "submit" class="btn green" id="edit_nunit_save" style="width:80px"><?php echo $this->lang->line('Save');?></button>
                </div>
            </div>
        </div>
    </div>
...
function publish_nunit(self)
{
    ...
    var enableStr = "<?php echo $this->lang->line('Publish');?>";
    var disableStr = "<?php echo $this->lang->line('UnPublish');?>";
