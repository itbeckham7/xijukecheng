                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="userDownLoadInfo_tbl">
                            ...
                            <tr>
                                ...
                                <th style="width:15%"><?php echo $this->lang->line('BuyCourse');?></th>
                            ...
                            <?php foreach($users as $user):
                                ...
                                $kebenju = $buyList->kebenju; $sandapian = $buyList->sandapian;
                                ...
                                if($sandapian=='1')  $buycourseStr .= $this->lang->line('sandapian');
								if($buycourseStr!='') $buycourseStr .= '<br/>';
                                if($grammar=='1')  $buycourseStr .= $this->lang->line('grammar');
                                ?>
                               <tr>
