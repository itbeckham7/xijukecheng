                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="courseInfo_tbl">
                            ...
                            <tr>
                                ...
                                <td align="center" data-school-type-id="<?= $course->school_type_id?>"><?php echo $course->school_type_name; ?></td>
                                <td>
                                    <button style="width:70px;" class="btn btn-sm btn-success"
                                            course_id="<?php echo $course->course_id; ?>"
                                            onclick="edit_course(this)"><?php echo $this->lang->line('Modify'); ?></button>
                                </td>
                            <tr>
                                <?php endforeach; ?>
                            </tbody>
                        ...
                        <div class="col-md-2">
                            <select class="form-control" id="cs_modify_school_type_name">
                                <?php foreach ($schoolTypes as $schoolType) : ?>
                                    <option value="<?php echo $schoolType->school_type_id?>"><?php echo $schoolType->school_type_name ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-1"></div>
            ...
            <div class="row">
                <div class="col-md-offset-1 col-md-9">
                    ...
                    <button type="button" class="btn green"
                            onclick="modify_course();"><?php echo $this->lang->line('Save'); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function edit_course(self) {
        ...
        var school_type_id = trtag.cells[2].getAttribute('data-school-type-id');
        ...
        jQuery("#cs_modify_school_type_name").val(school_type_id);
