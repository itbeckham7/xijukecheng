...
$imageAbsDir = base_url() . 'assets/images/xiaoxueapp/';
$user_type = $this->session->userdata("user_type");
$myworkURL = 'xiaoxueapp/work';
$hd_menu_img_path = '';
if ($user_type == '2') {
...
<div class="switch">
    <div style="position: relative; height: 100%; display: none">
        <img src="<?= $imageAbsDir . 'coursewares/country_cn.png'; ?>" id="select_country_img"
             data-baseurl="<?= base_url('assets/images/xiaoxueapp/coursewares') ?>" data-country="cn">
...
<div class="hdmenu">
    <?php if ($this->session->userdata("loggedin") != FALSE) { ?>
        <div style="position: relative; height: 100%">
            <img class="hdmenu_img" src="<?= $hd_menu_img_path . 'profile.png'; ?>">
            <!--<a id="hdmenu_studentwork" href="<?= base_url($myworkURL); ?>"
               style="top: 27.2%; left: 1.1%; width: 31.9%; height: 48.5%;"></a>-->
            <a id="hdmenu_profile" href="<?= base_url() . 'xiaoxueapp/users/profile/' . $loged_In_user_id; ?>"
               style="top: 3.9%; left: 0%; width: 100%; height: 93%;"></a>
            <!--<a id="hdmenu_community" href="<?= base_url() . 'community/index'; ?>"
               style="top: 27.2%; left: 67%; width: 31.9%; height: 48.5%;"></a>-->
        </div>
    <?php } ?>
</div>
...
<div class="back-btn">
    <a onmouseover="hover_back()" onmouseout="out_back()" href="#"  onclick="return_back('');">
        <img id="back_btn_image" src="<?= $imageAbsDir.'studentwork/back.png';?>">
    </a>
</div>
...
<div class="coursewarelist-wrapper">
    <?php foreach ($cwSets as $cw): ?>
        ...
        ?>
        <a href="<?= base_url() ?>xiaoxueapp/coursewares/view/<?= $cw->courseware_id ?>"
...
<script>
    ...
    var totalElems = 0;
    var totalPages = 0;
    var imageDir = baseURL + "assets/images/xiaoxueapp";
