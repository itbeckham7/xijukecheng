...
?>
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/css/xiaoxueapp/menu_manage.css')?>"
      xmlns="http://www.w3.org/1999/html">
<link rel = "stylesheet" type="text/css" href="<?= base_url('assets/css/xiaoxueapp/profile_student.css')?>">
<style>
    .share_item_title
    {
        background:url(<?= base_url('assets/images/xiaoxueapp/profile/item_bg.png')?>) no-repeat;
    ...
    {
        background:url(<?= base_url('assets/images/xiaoxueapp/profile/delete.png')?>) no-repeat;
        background-size: 100% 100%;
    }
    .comment_item_title
    {
...
<div class="bg">
    <img src="<?= base_url('assets/images/xiaoxueapp/profile/empty_bg.png')?>" class="background_image">
</div>
<a onclick="history.back()"
    class="return_btn"
    style="background:url(<?= base_url('assets/images/xiaoxueapp/studentwork/back.png')?>) no-repeat;background-size: 100% 100%;">
</a>

<div class="profile_bg">
    <img src="<?= base_url('assets/images/xiaoxueapp/profile/profile_bg.png')?>" class="profile_image">
</div>

<a  href="#" class="change_password_btn"
    style="background:url(<?= base_url('assets/images/xiaoxueapp/profile/pass_change.png')?>) no-repeat;background-size: 100% 100%;">
</a>

<a  href="#" class="edit_personal_info"
    style="background:url(<?= base_url('assets/images/xiaoxueapp/profile/info_edit.png')?>) no-repeat;background-size: 100% 100%;">
</a>
...
<!--<a  href="#" class="share_prev_btn"
    style="background:url(<?= base_url('assets/images/xiaoxueapp/profile/prev.png')?>) no-repeat;background-size: 100% 100%;">
</a>
<a  href="#" class="share_next_btn"
    style="background:url(<?= base_url('assets/images/xiaoxueapp/profile/next.png')?>) no-repeat;background-size: 100% 100%;">
</a>
...
//    var commentedList = '<?php //echo json_encode($commentedLists);?>//';
    ...
    var imageDir = baseURL + "assets/images/xiaoxueapp/profile/";
...
//        serialLblNumWarp.show();
    ...
    function updateStudentProfile(){
        ...
        $.ajax({
            type: "post",
            url: baseURL+"xiaoxueapp/users/update_student_person",
            dataType: "json",
            data: changedInfo,
    ...
    function updatePassword(){
        ...
        $.ajax({
            type: "post",
            url: baseURL+"xiaoxueapp/users/update_password",
            dataType: "json",
            data: changedInfo,
            success: function(res) {
                if(res.status=='success') {
...
<script src="<?= base_url('assets/js/custom/xiaoxueapp/menu_manage.js') ?>" type="text/javascript"></script>
<script src="<?= base_url('assets/js/custom/xiaoxueapp/profile_student.js') ?>" type="text/javascript"></script>