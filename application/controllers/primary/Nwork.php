...
class Nwork extends CI_Controller {
	...
	function view($userId)////$id is content id
    {
        if($this->signin_m->loggedin()) {
            ...
            $this->data["subview"] = "primary/nwork/view";
    ...
    function mynote($userId)
    {
        if($this->signin_m->loggedin()) {
            ...
            if($userId!=$loginUserId)
            {
                ...
                $this->data["subview"] = "primary/nwork/index";
                $this->load->view('primary/_layout_main', $this->data);
            }
    ...
    function teacher($teacherId)
    {
        if($this->signin_m->loggedin()) {
            ...
            if($user_type!='1')
            {
                ...
                $this->data["subview"] = "primary/nwork/teacher";
                $this->load->view('primary/_layout_main', $this->data);
            }
        }else{
            redirect(base_url().'signin/index');
    ...
    function output_html($ncontents,$content_type_slug)
    {
        ...
        if($content_type_slug!='note'){
            foreach ($ncontents as $ncontent):
                ...
                $output_html .= '<a class="op_download_btn btn"  download href="'.base_url('primary/').$ncontent->ncontent_file.'" onmouseover="hover_download(this)" onmouseout="out_download(this)"></a>';
            ...
            foreach ($ncontents as $ncontent):
                ...
                $output_html .= '<a class="op_delete_note_btn btn" 
                                          ...
                                          cloud_st="'.$ncontent->ncontent_cloud.'" 
                                          onclick="content_delete(this)" onmouseover="hover_delete(this)" onmouseout="out_delete(this)"></a>';
                $output_html .= '<a class="op_download_note_btn btn" download href="'.base_url('primary/').$ncontent->ncontent_file.'"  onmouseover="hover_download(this)" onmouseout="out_download(this)"></a>';
                $output_html .= '</td>';
            endforeach;
        }
        return $output_html;
    ...
    function outputContentForTeacher($ncontents,$content_type_slug)
    {
        ...
        if($content_type_slug!='note')
        {
            ...
            foreach ($ncontents as $ncontent):
                ...
                $output_html .= '<a class="op_download_note_btn btn" download href="'.base_url('primary/').$ncontent->ncontent_file.'" data-contentUrl="'.$ncontent->ncontent_file.'" onmouseover="hover_download(this)" onmouseout="out_download(this)"></a>';
                $output_html .= '</td>';
            endforeach;
        }
        return $output_html;
