...
class Nunits extends Admin_Controller
{
	...
	public function index()
	{
        ...
        $this->data["subview"] = "admin/nunits/index";
    ...
    function output_content($nunitSet)
    {
        ...
        foreach($nunitSet as $nunit):
            ...
            $output_html .=  '<button style="width:70px;" class="btn btn-sm btn-danger" onclick = "publish_nunit(this);" nunit_id = '.$nunit->nunit_id.'>'.$pub.'</button>';
            $output_html .= '</td>';
            $output_html .= '</tr>';
        endforeach;
        return $output_html;
